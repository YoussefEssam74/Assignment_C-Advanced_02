...
namespace Assignment_C_Advanced_02
{
    internal class Program
    {
        static void Main(string[] args)
        {
          ...
          //  queue.Enqueue("First"); // Enqueue elements
          ...
          //      Console.WriteLine(item);
          //  }
          //  Console.WriteLine("Dequeued Element: " + queue.Dequeue()); // Dequeue an element
          //  Console.WriteLine("Peeked Element: " + queue.Peek()); // Peek at the front element
        //Methods:
        //
